...
See [ADR 0005](docs/_DEPRECATED/adr/0005-platform-fumadocs-on-tanstack-start.md).
...
are [a parked spike](docs/_DEPRECATED/plans/2026-08-04-per-version-lua-spike.md). If you
...
- [docs/_DEPRECATED/](docs/_DEPRECATED/) — the whole previous record, kept intact rather than
...
`docs/_DEPRECATED/adr/`. They are repointed when the rebuilt decisions are numbered.
